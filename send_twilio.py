...
def twilio_sms_scheduler():
        ...
        for event in sms_events:
            ...
            message = client.messages.create(
                  to=event.user.phone, from_="+19193733763", body="This is a reminder to update the event desc here- http://www.thefearapp.com/twilio/encrypted_eventid", statuscallback="http://thefearapp.com/twiliosmsresponses")
